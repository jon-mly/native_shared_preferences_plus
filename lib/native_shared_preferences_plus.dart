...
class NativeSharedPreferencesPlus {
  NativeSharedPreferencesPlus._(this._preferenceCache);

  static const String _prefix = '';
  static Completer<NativeSharedPreferencesPlus>? _completer;

  static NativeSharedPreferencesPlusPlatform get _store {
    return NativeSharedPreferencesPlusPlatform.instance;
  }
  ...
  static Future<NativeSharedPreferencesPlus> getInstance() async {
    if (_completer == null) {
      final completer = Completer<NativeSharedPreferencesPlus>();
      try {
        final Map<String, Object> preferencesMap =
        await _getSharedPreferencesMap();
        completer.complete(NativeSharedPreferencesPlus._(preferencesMap));
      } on Exception catch (e) {
        // If there's an error, explicitly return the future with an error.
        // then set the completer to null so we can retry.
        completer.completeError(e);
        final Future<NativeSharedPreferencesPlus> sharedPrefsFuture =
            completer.future;
        _completer = null;
  ...
  Future<void> reload() async {
    ...
    await NativeSharedPreferencesPlus._getSharedPreferencesMap();
    _preferenceCache.clear();
